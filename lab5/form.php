  ...
  <div class="container">
    <div class="row">
      <div class="form my-3">
        <div class="row">
          <div class="col">
            <h1 class="col text-center mt-3" id="staticBackdropLabel">Форма</h5>
          </div>
          <div class="col text-center pt-4"><a href="index.php" type="button" class="btn btn-outline-dark">Вернуться ко
              входу</a></div>
        </div>
        <div class="modal-body">
          ...
          if ($flag == 1) {
            echo '<div class="alert alert-success">Форма успешно отправлена!<br>Ваш логин: '. $username .'<br>Ваш пароль: '. $password . '</div>';
            ...
            try {
              ...
              $stmt = $db->prepare("INSERT INTO users VALUES (null,:app_id,:login,:password,:password_hash)");
              $stmt->execute(['app_id' => $ap_id, 'login' => $username, 'password' => $password, 'password_hash' => $password_hash]);
